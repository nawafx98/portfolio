        ...
        <div className="timeline">
          <div className="item">
            ...
            <div className="texts">
              ...
              <h4>Labayh, Medina</h4>
              <p>I performed the processing and analysis of production data, extracting pivotal insights crucial for informed decision-making. In addition, I designed and launched data-centric dashboards that effectively conveyed key performance metrics to stakeholders. My role also involved leading the creation of AI models, including an AI chatbot and a Sentiment Analysis tool, which were instrumental in streamlining tasks and bolstering data-driven approaches. Furthermore, I undertook advanced data analysis to pinpoint trends, patterns, and anomalies, leading to enhanced operational efficiency. This comprehensive approach not only optimized current processes but also paved the way for more innovative and efficient methods in handling data and making strategic decisions.</p>
            </div>
          </div>
          <div className="item">
            <div className="date"><span className="year">2023</span><span className="arrow"></span></div>
